...
logo = PhotoImage(file='D:\CODECLAUSE INTERNSHIP\PYTHON Intern\Mail Application with GUI\MailApplicationwithGUI\email.png')
Label_Title = Label(Frame_Title, text='  EMAIL APPLICATION ', image=logo, compound=LEFT, font=('luicda', 30, 'bold'),
                    bg='grey')
Label_Title.grid(row=0, column=0)
settingIMG = PhotoImage(file='D:\CODECLAUSE INTERNSHIP\PYTHON Intern\Mail Application with GUI\MailApplicationwithGUI\setting.png')
...
browseImage =PhotoImage(file='D:\CODECLAUSE INTERNSHIP\PYTHON Intern\Mail Application with GUI\MailApplicationwithGUI\Browse.png')
...
attachImage = PhotoImage(file='D:\CODECLAUSE INTERNSHIP\PYTHON Intern\Mail Application with GUI\MailApplicationwithGUI\Attachments.png')
